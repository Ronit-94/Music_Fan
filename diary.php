  ...
  if(!isset($_FILES['file']) || $_FILES['file']['error'] == UPLOAD_ERR_NO_FILE) {
   $sql = "INSERT into diary (user_id, diary_title, description, privacy_D,location,multimedia) VALUES ($_SESSION[user_id],'$_POST[diary_title]','$_POST[description]',$_POST[privacyd],'$_POST[location]','')";
    if (mysqli_query($con, $sql)) {
        echo "<div class=a>"."Diary created successfully"."</div>";
    } else {
...
|| ($_FILES["file"]["type"] == "image/jpeg"))
  {
    ...
    if (mysqli_query($con, $sql)) {
        ...
        echo "Error: " . $sql . "<br>" . mysqli_error($con);
        echo "<div style=font-weight:bold;color:#00FFE8>"."Only jpg,jpeg,mp4 files supported"."</div>";
    }
  }else {
        //echo "Error: " . $sql . "<br>" . mysqli_error($con);
        echo "<div style=font-weight:bold;color:#00FFE8>"."Only jpg,mp4,png files supported"."</div>";
    }
  }
}
?>
...
<h2 style="font-weight:bold;color: #FA2F76">New Post</h2> 
<div style="font-weight:bold; color:#FA2F76">
...
<br>Attach a File:<input style="padding-left:590px; font-size:20px; font-weight:bold" type="file" name="file"  value='Upload Picture' />
</b>
<br>
