...
{
    header('Location: http://localhost:81/registration.php');
}
mysqli_close($con);
?>
...
<style>
body {
   background-image: url("https://images.pexels.com/photos/130991/pexels-photo-130991.jpeg?w=940&h=650&auto=compress&cs=tinysrgb");
...
<div style="font-weight:bold; color:#FA2F76; font-size:18px;">
<body style="text-align: center">
	<h1 > Welcome to Music Fan Social Network </h1>
...
{
	echo "<div class=error>"."<strong>Username or Password is Incorrect</strong>"."</div>";
}
mysqli_close($con);
}
?>